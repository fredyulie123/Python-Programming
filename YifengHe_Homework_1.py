...
#print("In", num_year, "years","at the interest rate of", annual_rate, "% compounded", term_num, "times per year")
#print("the initial amount of $", principal_num, 'will be worth ', '${0:,.2f}'.format(future_value), '${0:,.2f}'.format(interest_num), "will be paid in interest")